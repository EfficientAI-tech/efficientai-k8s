...
| `values-gke-high-concurrency.yaml` | GKE overlay: 4–8 worker-imports pods × 32 threads (128–256 Celery threads) |
...
# Optional: high-concurrency worker-imports pool (128 threads steady, 256 at HPA max)
